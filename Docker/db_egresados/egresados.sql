...
CREATE TABLE IF NOT EXISTS egresado_db.Convocatoria (
  ...
  PRIMARY KEY (con_id, Empresa_idNit),
    FOREIGN KEY (Empresa_idNit)
...
CREATE TABLE IF NOT EXISTS egresado_db.Convocatorias_aplicadas (
  ...
  Informacion_personal_egresado_numero_documento_identidad INT NOT NULL,
  conv_apl_fecha_aplicacion DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (con_apl_id, con_apl_emp_idNit, Informacion_personal_egresado_numero_documento_identidad),
    FOREIGN KEY (con_apl_id , con_apl_emp_idNit)
    REFERENCES egresado_db.Convocatoria (con_id , Empresa_idNit)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
    FOREIGN KEY (Informacion_personal_egresado_numero_documento_identidad)
...
CREATE TABLE IF NOT EXISTS egresado_db.Familiar (
  ...
  Hijo_egresado_documento INT NOT NULL,
  PRIMARY KEY (fam_egr_numero_documento_identidad, Hijo_egresado_documento),
    FOREIGN KEY (fam_egr_numero_documento_identidad)
    REFERENCES egresado_db.Informacion_personal_egresado (egr_numero_de_identificacion)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
    FOREIGN KEY (Hijo_egresado_documento)
    REFERENCES egresado_db.Hijo_egresado (fam_hij_documento)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS egresado_db.Hijo_egresado (
  fam_hij_documento INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS egresado_db.Jefe (
  documento_egresado INT NOT NULL,
  ...
  PRIMARY KEY (documento_egresado),
    FOREIGN KEY (documento_egresado)
    REFERENCES egresado_db.Trabajo (tra_egr_documento_egresado)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS egresado_db.Trabajo (
  ...
  Empresa_emp_id_Nit INT NOT NULL,
  PRIMARY KEY (tra_egr_documento_egresado),
    FOREIGN KEY (tra_egr_documento_egresado)
    REFERENCES egresado_db.Informacion_personal_egresado (egr_numero_de_identificacion)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
    FOREIGN KEY (Empresa_emp_id_Nit)
    REFERENCES egresado_db.Empresa (emp_idNit)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS egresado_db.asesoria (
  ...
  PRIMARY KEY (ase_egr_numero_de_identificacion, ase_est_pre_numero_de_identificacion),
...
CREATE TABLE IF NOT EXISTS egresado_db.beca (
  ...
  PRIMARY KEY (bec_est_programa_formativo, bec_est_documento_egresado),
    ...
    REFERENCES egresado_db.estudio_realizado (documento_egresado , est_programa)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = '	';
...
CREATE TABLE IF NOT EXISTS egresado_db.contacto (
  ...
  dat_numero_telefono_adicional INT NULL,
  dat_correo_adicional VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS egresado_db.estudio_realizado (
  ...
  PRIMARY KEY (documento_egresado, est_programa),
    FOREIGN KEY (documento_egresado)
    REFERENCES egresado_db.Informacion_personal_egresado (egr_numero_de_identificacion)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS egresado_db.investigacion_del_egresado (
  ...
  inv_proy_invid_colciencias VARCHAR(45) NOT NULL,
  inv_rol_en_grupo VARCHAR(45) NOT NULL,
  inv_fecha_inicio DATE NOT NULL,
  inv_fecha_finalizacion DATE NOT NULL,
  PRIMARY KEY (inv_documento_egresado, inv_proy_invid_colciencias),
    FOREIGN KEY (inv_documento_egresado)
    REFERENCES egresado_db.Informacion_personal_egresado (egr_numero_de_identificacion)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
    FOREIGN KEY (inv_proy_invid_colciencias)
    REFERENCES egresado_db.proyecto_de_investigacion (pro_invid_colciencias)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS egresado_db.prestamo (
  ...
  PRIMARY KEY (pre_egr_numero_documento_identidad, pre_lib_id),
...
CREATE TABLE IF NOT EXISTS egresado_db.proyecto_de_investigacion (
  pro_invid_colciencias VARCHAR(45) NOT NULL,
  pro_inv_nombre_grupo VARCHAR(45) NOT NULL,
  pro_inv_descripcion LONGTEXT NOT NULL,
  institucion VARCHAR(45) NOT NULL,
  PRIMARY KEY (pro_invid_colciencias))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table egresado_db.redes_sociales_egresado
-- -----------------------------------------------------
DROP TABLE IF EXISTS egresado_db.redes_sociales_egresado ;

CREATE TABLE IF NOT EXISTS egresado_db.redes_sociales_egresado (
  red_nombre_red_social VARCHAR(45) NOT NULL,
  red_usuario VARCHAR(45) NOT NULL,
  red_documento_egresado INT NOT NULL,
  PRIMARY KEY (red_documento_egresado, red_nombre_red_social),
    FOREIGN KEY (red_documento_egresado)
    REFERENCES egresado_db.Informacion_personal_egresado (egr_numero_de_identificacion)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
